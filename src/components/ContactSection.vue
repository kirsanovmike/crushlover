          ...
          <v-row justify="center">
            <v-col cols="12">
              ...
              <h3 class="font-weight-light mt-3">
                ...
                work of the service. Best regards, the Crush Lover team.
              </h3>
              <h3 class="font-weight-light mt-3">
              ...
              <h3 class="font-weight-light mt-3">
                Email:
                <a href="mailto: crushlover120@gmail.com">
                  crushlover120@gmail.com
                </a>
              </h3>
              <h3 class="font-weight-light mt-3">
                We in telegram:
                <a href="https://t.me/lover_family" target="_blank">
                  Crush Lover Telegram
                </a>
              </h3>
            </v-col>
          </v-row>
